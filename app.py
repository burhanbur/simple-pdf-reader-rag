...
if uploaded_file is not None:
    ...
    text_splitter = SemanticChunker(HuggingFaceEmbeddings(model_name="distilbert-base-nli-stsb-mean-tokens"))
    documents = text_splitter.split_documents(docs)

    # Instantiate the embedding model
    # embedder = HuggingFaceEmbeddings()
    embedder = HuggingFaceEmbeddings(model_name="distilbert-base-nli-stsb-mean-tokens")
